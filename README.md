...
Install - https://github.com/Carthage/Carthage/releases/download/0.23.0/Carthage.pkg
Click on the Carthage.pkg file go over the installation step by step.

Run  - carthage update on command prompt under the project folder.
